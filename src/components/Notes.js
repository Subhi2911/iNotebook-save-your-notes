                            ...
                            <form className='my-3'>
                                <div className="mb-3">
                                    ...
                                    <div style={{height:'0.8rem'}}>
                                        <div id="titleHelp" className="form-text" style={{ visibility: note.etitle.length < 5 ? 'visible' : 'hidden' }}>Title must have at least 5 characters.</div>
                                    </div>
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="edescription" className="form-label">Description</label>
                                    <textarea type="text" className="form-control" id="edescription" rows='3' name="edescription" value={note.edescription} onChange={onChange} minLength={5} required />
                                    <div style={{height:'0.8rem'}}>
                                        <div id="descriptionHelp" className="form-text" style={{ visibility: note.edescription.length < 5 ? 'visible' : 'hidden' }}>Description must have at least 5 characters</div>
                                    </div>
                                </div>
                                <div className="mb-3">
